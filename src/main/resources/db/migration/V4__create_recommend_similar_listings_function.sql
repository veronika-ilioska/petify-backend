CREATE OR REPLACE FUNCTION get_recommended_listings_for_user(
    p_user_id bigint
)
    RETURNS TABLE (
                      listing_id bigint,
...
SELECT
    ...
    a.breed::text AS breed,
    a.located_name::text AS location,
    l.created_at,
    m.cf_score,
